...
$liczbaProduktow = intval($_POST['liczba']);
...
imagedestroy($image);
session_start();
// przypisywanie wartosci do zmiennych sesyjnych
$_SESSION["powrot"] = true;
$_SESSION["wartosc0"] = $nazwaSprzedawcy;
$_SESSION["wartosc1"] = $ulicaSprzedawcy;
$_SESSION["wartosc2"] = $miejscowoscSprzedawcy;
$_SESSION["wartosc3"] = $numerRachunku1;
$_SESSION["wartosc4"] = $numerRachunku2;
$_SESSION["wartosc5"] = $nazwaMiejscowosci;
$_SESSION["wartosc6"] = $dataWystawieniaRachunku;
$_SESSION["wartosc7"] = $nazwaOdbiorcy;
$_SESSION["wartosc8"] = $liczbaProduktow;
for ($i = 0; $i < 6; $i++){
  $_SESSION["cena".$i] = $_POST["cena".($i+1)];
  $_SESSION["nazwa".$i] = $_POST["nazwa".($i+1)];
  $_SESSION["ilosc".$i] = $_POST["ilosc".($i+1)];
}
?>
<html>
    <head>
    ...
    <body>
      <div id="glownyDiv">
        <button style="height: 50px; width:100px; background-color: red; color: white;" onclick="location.href='index.php'">Powrot</button><br><br>
        <div id="obrazekDiv">
